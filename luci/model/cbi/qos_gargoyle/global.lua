...
s = m:section(NamedSection, "config", "qos_gargoyle", translate("<p>如需帮助:<a target=\"_blank\" href=\"http://myop.ml/archives/category/firmware-guide/\">请查看使用教程</a></p>"))
...
function e.write(self, section, value)
	if value == "0" then
		...
		os.execute("uci set qosv4.@qos_settings[0].enable=0 && uci commit")

...
s=m:section(TypedSection, "transmission", translate("Global settings"), translate("<p>如需帮助:<a target=\"_blank\" href=\"http://myop.ml/archives/category/firmware-guide/\">请查看使用教程</a></p>"))
s.addremove=false
s.anonymous=true

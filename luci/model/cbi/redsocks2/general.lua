...
s = m:section(TypedSection, "redsocks2_base", translate("Basic Settings"), translate("A modified version of redsocks.Beside the basic function of redsocks,it can redirect TCP connections which are blocked via proxy automatically without a blacklist."))
s.anonymous = true
...
s = m:section(TypedSection, "redsocks2_udprelay", translate("UDP Relay"), translate("If use shadowsocks,the Proxy options should be the same as Redirector."))
s.anonymous = true
s.addremove = false
...
o = s:option(Value, "dest_port", translate("Destination Port"), translate("This port should be the same as Redirector's local port."))
o.default = "11111"
o.datatype = "uinteger"

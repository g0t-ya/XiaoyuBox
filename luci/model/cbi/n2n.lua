...
local edge =(luci.sys.call("pidof edge > /dev/null") == 0)
local supernode =(luci.sys.call("pidof supernode > /dev/null") == 0)
if edge or supernode then	
	m = Map("n2n", translate("N2N VPN Server"), translate("N2N is running"))
else
	m = Map("n2n", translate("N2N VPN Server"), translate("N2N is not running"))
end

s = m:section(TypedSection, "setting", translate("setting") ,translate("This is n2n VPN Server."))
s.addremove = false
s.anonymous = true

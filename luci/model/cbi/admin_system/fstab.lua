...
s = m:section(TypedSection, "ntfs", "ntfs_mount", translate("config","config"))
s.anonymous = true

enable = s:option(Flag, "ntfs3g_mount", translate("ntfs3g_mount"),translate("Ntfs3g_mount use to choose ntfs-3g for mounting NTFS."))

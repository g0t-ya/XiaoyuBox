...
task_Saturday=task:option(Flag, "task_Saturday", translate("Saturday"))
task_Saturday.disabled = 0
...
task_time:value("everym_1", translate("every_1_minute"))
...
task_task:value("/usr/lib/ddns/dynamic_dns_updater.sh", translate("DDNS UP"))
task_task:value("/root/pppoemy/autodetect", translate("并拨检测脚本"))

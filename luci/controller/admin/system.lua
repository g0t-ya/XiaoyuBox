...
function index()
	...
	entry({"admin", "system", "crontab"}, alias("admin","system","crontab","crontab"), _("Scheduled Tasks"), 46)
	entry({"admin", "system", "crontab", "crontab"}, cbi("admin_system/crontab"), _("Scheduled Tasks"), 46).leaf = true
	entry({"admin", "system", "crontab", "crontab2"}, cbi("admin_system/crontab2"), _("Scheduled Tasks 2"), 47).leaf = true
